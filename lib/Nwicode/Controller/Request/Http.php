...
/**
 * Nwicode_Controller_Request_Http
 *
 * HTTP request object for use with Zend_Controller family.
 * Add set & getMediaUrl
 *
 * @uses Zend_Controller_Request_Abstract
 * @package Nwicode_Controller
 * @subpackage Request
 */
class Nwicode_Controller_Request_Http extends Zend_Controller_Request_Http
{
    ...
    /**
     * Nwicode_Controller_Request_Http constructor.
     * @param null $uri
    ...
    protected function _initApplication($paths)
    {
        ...
        if ($this->_application && Nwicode_Version::is("PE")) {

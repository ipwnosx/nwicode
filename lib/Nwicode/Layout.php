...
use Nwicode\View;
use Nwicode\Cache\Design as CacheDesign;

/**
 * Class Layout
 * @package Nwicode
 */
class Nwicode_Layout extends Zend_Layout
{
    /**
     *
     */
    const DEFAULT_CLASS_VIEW = "Nwicode_View";
     ...
     * @var string
     */
    protected $_pluginClass = 'Nwicode_Layout_Controller_Plugin_Layout';
     ...
     * @param $filename
     * @param $nodename
     * @return \Nwicode\Layout\Email
     */
    public function loadPartial($filename, $nodename)
    {
        $layout = new Nwicode\Layout\Email($filename, $nodename);

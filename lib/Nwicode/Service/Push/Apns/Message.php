...
/**
 * Class Nwicode_Service_Push_Apns_Message
 *
 * Custom APNS Message, with specific values from NwicodeCMS
 */
class Nwicode_Service_Push_Apns_Message extends ApnsPHP_Message_Custom {

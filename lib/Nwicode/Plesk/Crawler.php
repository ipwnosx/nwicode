...
class Nwicode_Plesk_Crawler
{
     ...
     *
     * Nwicode_Plesk_Crawler constructor.
     * @param $host
     * @param $username
     * @param $password
     * @throws Exception
    ...
    public function __construct($host, $username, $password)
    {
        ...
        $this->client = new Nwicode_Plesk_Client();
    ...
    public function login()
    {
        ...
        try {
            ...
            throw new Exception("[Nwicode_Plesk_Crawler]: Unable to log in Plesk, with message %s.", $e->getMessage());
        }
    }
    ...
    public function updateDomain($hostname, $id)
    {
        ...
        try {
            $cert_name = sprintf("%s-%s", "nwicode_letsencrypt", $hostname);
            ...
            throw new Exception(__("[Nwicode_Plesk_Crawler]: Unable to save certificate, with message %s.", $e->getMessage()));
        }

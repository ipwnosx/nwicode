...
class Mail extends Zend_Mail
{
    ...
    public function send($transport = null)
    {
        ...
        //    $this->_sender_name = Nwicode::getApplication()->getName();
        //}
        ...
        try {
            ...
            log_err("[Nwicode_Mail] an error occurred while sending the following e-mail.");
            log_err(__("[Nwicode_Mail::Error] %s.", $e->getMessage()));

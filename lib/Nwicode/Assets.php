...
class Assets
{
    ...
    public static function compileScss($path)
    {
        ...
        $content = [];
        $f = fopen(path("var/apps/browser/scss/ionic.nwicode.variables-opacity.scss"), "r");
        if ($f) {
    ...
    public static function buildIndex()
    {
        ...
        foreach (self::$platforms as $type => $platforms) {
            ...
            foreach ($platforms as $platform) {
                ...
                # Build the templateCache, Nwicode 5.0
    ...
    /**
     *  When subclassing Nwicode_Assets, you can override this method

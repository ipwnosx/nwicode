...
use Core_Model_Directory as NwicodeDirectory;
...
class Image extends GregwarImage
{
                                ...
                                $width = null, $height = null)
    {
        ...
        $this->setCacheDir(NwicodeDirectory::getImageCacheDirectory(true));
                                        ...
                                        $returnInfos = false)
    {
        if (isset($resource) && is_file($resource)) {
            ...
            throw new Exception(
                __('[Error] Nwicode_Image, no resource provided.'));
        }
    }

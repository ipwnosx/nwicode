...
{
    \Nwicode\Utils::log_emerg($message);
}
...
{
    \Nwicode\Utils::log_alert($message);
}
...
{
    \Nwicode\Utils::log_crit($message);
}
...
{
    \Nwicode\Utils::log_warn($message);
}
...
{
    \Nwicode\Utils::log_notice($message);
}
...
{
    \Nwicode\Utils::log_info($message);
}
...
{
    \Nwicode\Utils::log_debug($message);
}

function log_exception(Exception $e)
{
    log_debug(sprintf("[Nwicode_Exception] %s", $e->getMessage()));
    \Nwicode\Debug::addException($e);
}

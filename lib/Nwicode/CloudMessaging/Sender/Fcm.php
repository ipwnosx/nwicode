...
namespace Nwicode\CloudMessaging\Sender;

use Nwicode\CloudMessaging\InvalidRequestException as InvalidRequestException;
use Nwicode\CloudMessaging\Message as Message;
use Nwicode\CloudMessaging\MulticastResult as MulticastResult;
use Nwicode\CloudMessaging\AggregateResult as AggregateResult;
use Nwicode\CloudMessaging\Result as Result;
use Nwicode\CloudMessaging\Log as Log;
use Nwicode\CloudMessaging\Constants as Constants;

/**
 * Class Fcm
 * @package Nwicode\CloudMessaging\Sender
 */
class Fcm
{
    ...
    public function __construct($key)
    {
        ...
        $this->logger = new \Nwicode\CloudMessaging\Log('Fcm');
    }

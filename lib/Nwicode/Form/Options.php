...
/**
 * Class Nwicode_Form_Options
 */
class Nwicode_Form_Options extends Nwicode_Form_Options_Abstract
{
    /**
    ...
    public function init()
    {
        ...
        if ($this->layout->getVisibility() == Application_Model_Layout_Homepage::VISIBILITY_ALWAYS) {
            ...
            $this->addSimpleCheckbox("layout_visibility_autostart_first", __("Autoload first feature"));
        }

...
/**
 * Class Nwicode_Form_Abstract
 *
 * @method $this setAction(string $action)
 * @method $this setAttrib(string $key, mixed $value)
 */
abstract class Nwicode_Form_Abstract extends Zend_Form
{
    ...
    /**
     * @var Nwicode_Form_Element_Button
     */
    public $mini_submit;
    ...
    public function addSubmit($label = null, $name = null)
    {
        ...
        $submit = new Nwicode_Form_Element_Submit($name);
     ...
     * @param null $label_on
     * @return Nwicode_Form_Element_Button
     * @throws Zend_Form_Exception
     */
    public function addMiniSubmit($label = null, $label_off = null, $label_on = null)
    {
        ...
        $submit = new Nwicode_Form_Element_Button($label);
        $this->addElement($submit);
    ...
    {
        $el = new Nwicode_Form_Element_Text($name);
        $this->addElement($el);
        if ($placeholder) {
     ...
     * @param string $label
     * @param bool $placeholder
     * @return Nwicode_Form_Element_Email
     * @throws Zend_Form_Exception
     */
    public function addSimpleEmail($name, $label = "", $placeholder = false)
    {
        $el = new Nwicode_Form_Element_Email($name);
        $this->addElement($el);
        if ($placeholder) {
            $el->setAttrib('placeholder', $label);
            $el->setDecorators(['ViewHelper']);
    ...
    {
        $el = new Nwicode_Form_Element_Button($name);
        $this->addElement($el);
        if ($placeholder) {
            $el->setAttrib('placeholder', $label);
            $el->setDecorators(['ViewHelper']);
     ...
     * @return Nwicode_Form_Element_Slider
     * @throws Zend_Form_Exception
     */
    public function addSimpleSlider($name, $label = "", $options = [], $with_indicator = true)
    {
        ...
        $el = new Nwicode_Form_Element_Slider($name, $options);
        $this->addElement($el);
        $el->setLabel($label);
        $el->setDecorators(['ViewHelper', 'Label']);
        $el->setIsFormHorizontal($this->is_form_horizontal);
    ...
    {
        $el = new Nwicode_Form_Element_Password($name);
        $this->addElement($el);
        if ($placeholder) {
            $el->setAttrib('placeholder', $label);
            $el->setDecorators(['ViewHelper']);
     ...
     * @param $name
     * @param string $label
     * @return Nwicode_Form_Element_Textarea
     * @throws Zend_Form_Exception
     */
    public function addSimpleTextarea($name, $label = "", $placeholder = false, $options = [])
    {
        $el = new Nwicode_Form_Element_Textarea($name);
        $this->addElement($el);
        if ($placeholder) {
            $el->setAttrib('placeholder', $label);
            $el->setDecorators(['ViewHelper']);
     ...
     * @param string $label
     * @param $options
     * @return Nwicode_Form_Element_Select
     * @throws Zend_Form_Exception
     */
    public function addSimpleSelect($name, $label = "", $options = [])
    {
        $el = new Nwicode_Form_Element_Select($name);
        $this->addElement($el);
        $el->setIsFormHorizontal($this->is_form_horizontal);
        $el->setColor($this->color);
        $el
     ...
     * @param string $label
     * @param $options
     * @return Nwicode_Form_Element_Multiselect
     * @throws Zend_Form_Exception
     */
    public function addSimpleMultiSelect($name, $label = "", $options)
    {
        $el = new Nwicode_Form_Element_Multiselect($name);
        $this->addElement($el);
        $el->setIsFormHorizontal($this->is_form_horizontal);
        $el->setColor($this->color);
        $el
     ...
     * @return Nwicode_Form_Element_Html
     * @throws Zend_Form_Exception
     */
    public function addSimpleHtml($name, $html, $attributes = [])
    {
        $el = new Nwicode_Form_Element_Html($name, $attributes);
        $this->addElement($el);
        $el->setIsFormHorizontal($this->is_form_horizontal);
        $el
            ->setValue($html)
     ...
     * @param $name
     * @param $label
     * @return Nwicode_Form_Element_Checkbox
     * @throws Zend_Form_Exception
     */
    public function addSimpleCheckbox($name, $label)
    {
        $el = new Nwicode_Form_Element_Checkbox($name);
        $this->addElement($el);
        $el->setIsFormHorizontal($this->is_form_horizontal);
        $el->setColor($this->color);
        $el
     ...
     * @param $label
     * @param array $options
     * @return Nwicode_Form_Element_Radio
     * @throws Zend_Form_Exception
     */
    public function addSimpleRadio($name, $label, $options = [])
    {
        $el = new Nwicode_Form_Element_Radio($name);
        $this->addElement($el);
        $el->setIsFormHorizontal($this->is_form_horizontal);
        $el->setColor($this->color);
        $el
     ...
     * @param $label
     * @param $options
     * @return Nwicode_Form_Element_MultiCheckbox
     * @throws Zend_Form_Exception
     */
    public function addSimpleMultiCheckbox($name, $label, $options = [])
    {
        $el = new Nwicode_Form_Element_MultiCheckbox($name);
        $this->addElement($el);
        $el->setIsFormHorizontal($this->is_form_horizontal);
        $el->setColor($this->color);
        $el
    ...
    public function addSimpleImage($name, $label = "", $button_text = "", $options = [])
    {
        ...
        /** Visual image button */
        $image_button = new Nwicode_Form_Element_Button("{$name}_button");
        ...
        /** Fake uploader */
        $image_input = new Nwicode_Form_Element_File("{$name}_fake_files", __("uploader"));
        ...
        $image_hidden = new Nwicode_Form_Element_Hidden($name);
    ...
    public function addSimpleFile($name, $label = "", $options = [])
    {
        ...
        /** Visual image button */
        $button = new Nwicode_Form_Element_Button($name);
        ...
        /** Fake uploader */
        $input_file = new Nwicode_Form_Element_File("{$name}_hidden", __("uploader"));
    ...
    /**
     * @param $name
     * @return Nwicode_Form_Element_Hidden
     * @throws Zend_Form_Exception
     */
    public function addSimpleHidden($name)
    {
        $el = new Nwicode_Form_Element_Hidden($name);
        $this->addElement($el);
        $el->setDecorators(['ViewHelper']);
    ...
    public static function handlePicture($optionValue, $object, $key, $value)
    {
        if ($value == '_delete_') {
            ...
            $path_banner = Nwicode_Feature::moveUploadedFile(
                $optionValue,

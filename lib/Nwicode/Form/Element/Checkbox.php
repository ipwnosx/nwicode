<?php
/**
 * Class Nwicode_Form_Element_Checkbox
 */
class Nwicode_Form_Element_Checkbox extends Zend_Form_Element_Checkbox {
	...
	public function addClass($new) {
		Nwicode_Form_Abstract::addClass($new, $this);
	...
	public function setTooltip($title){
		...
		Nwicode_Form_Abstract::addClass('sb-tooltip', $decorator, true);

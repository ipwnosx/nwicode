...
class Nwicode_DirectAdmin {
    ...
    /**
     * @var Nwicode_DirectAdmin_HTTPSocket
     */
    public $socket = null;
    ...
    public function __construct() {
        ...
        $this->socket = new Nwicode_DirectAdmin_HTTPSocket();
    ...
    public function updateCertificate($ssl_certificate) {
        ...
        $this->logger->info(__("[Nwicode_DirectAdmin] Updated DirectAdmin SSL Certificate for %s, %s", $webspace, print_r($result, true)));

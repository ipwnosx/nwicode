...
angular.module('starter').provider('HomepageLayout', function () {
    ...
    self.$get = function ($injector, $ionicSlideBoxDelegate, $ionicPlatform, $ionicHistory, $location, $log, $q,
        ...
        HomepageLayout._init = function () {
            ...
            console.log("HomepageLayout._init;");
            console.log(HomepageLayout.data);
            ...
            HomepageLayout.properties.options.autoSelectFirst =
                ...
                HomepageLayout.properties.options.autoSelectFirst = HomepageLayout.data.layout_visibility_autostart_first;
            HomepageLayout._updateFromUrl($location.absUrl());

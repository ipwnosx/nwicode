    ...
    return {
        getIosBuildLicenseInfo : function(licenseKey) {
            return $q(function(resolv, reject){
                $http({
                    method: 'GET',
                    url: "https://extensions.nwicodecms.com/?edd_action=check_license&item_name=ios-auto-publish-build-send-your-ios-app-to-itunes-automatically&license="+licenseKey,
                    cache: false,
                    responseType:'json'
                })
        ...
        getNwicodecCMSLicenseInfo : function(licenseKey) {
            return $q(function(resolv, reject){
                $http({
                    method: 'POST',
                    url: "/system/backoffice_config_general/checknwicodecmslicense",
                    cache: false,
                    responseType:'json',
                    data: {

        ...
        return {
            ...
            controller: ['$scope', '$attrs', '$http', function($scope, $attrs, $http) {
                ...
                function requestRange(request) {
                    ...
                    /** @Nwicode, save original perPage in case of smaller result */
                    $scope.originalPerPage = $scope.perPage;
                    ...
                    responsePromise.then(function (rsp) {
                        ...
                        if(response) {
                            ...
                            if(length(response) <= response.total) {
                                /** @Nwicode, <= unless of < & `( response.total >= 1 ) ||` */
                                if(
                        ...
                        /** @Nwicode, originalPerPage unless of perPage */
                        $scope.numPages = Math.ceil($scope.numItems / ($scope.originalPerPage || defaultPerPage));

                        /** @Nwicode, restoring perPage */
                        $scope.perPage = $scope.originalPerPage;

...
$blocks = [
    ...
    [
        ...
        'children' => [
            [
                'code' => 'ionic_primary_color',
                'name' => 'Primary',
                'ion_color' => '#3880ff',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#3171e0',
                'ion_color_tint' => '#4c8dff',
            ],
            [
                'code' => 'ionic_secondary_color',
                'name' => 'Secondary',
                'ion_color' => '#0cd1e8',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#0bb8cc',
                'ion_color_tint' => '#24d6ea',
            ],
			[
                'code' => 'ionic_tertiary_color',
                'name' => 'Tertiary',
                'ion_color' => '#7044ff',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#633ce0',
                'ion_color_tint' => '#7e57ff',
            ],
			[
                'code' => 'ionic_success_color',
                'name' => 'Success',
                'ion_color' => '#10dc60',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#0ec254',
                'ion_color_tint' => '#28e070',
            ],
			[
                'code' => 'ionic_warning_color',
                'name' => 'Warning',
                'ion_color' => '#ffce00',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#e0b500',
                'ion_color_tint' => '#ffd31a',
            ],			
			[
                'code' => 'ionic_danger_color',
                'name' => 'Danger',
                'ion_color' => '#f04141',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#d33939',
                'ion_color_tint' => '#f25454', 
            ],
			[
                'code' => 'ionic_dark_color',
                'name' => 'Dark',
                'ion_color' => '#222428',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#1e2023',
                'ion_color_tint' => '#383a3e',
            ],
			[
                'code' => 'ionic_medium_color',
                'name' => 'Medium',
                'ion_color' => '#989aa2',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#86888f',
                'ion_color_tint' => '#a2a4ab',
            ],
			[
                'code' => 'ionic_light_color',
                'name' => 'Light',
                'ion_color' => '#f4f5f8',
                'ion_color_contrast' => '#000000',
                'ion_color_shade' => '#d7d8da',
                'ion_color_tint' => '#f5f6f9',
            ],
			[
                'code' => 'ionic_text_color',
                'name' => 'Main ionic color',
                'ion_color' => '#404040',
                'ion_color_contrast' => '#dddddd',
                'ion_color_shade' => '',
                'ion_color_tint' => '#fffcf5',
            ],
			[
                'code' => 'ionic_item_color',
                'name' => 'Item ionic color',
                'ion_color' => '#404040',
                'ion_color_contrast' => '#ffffff',
                'ion_color_shade' => '#dadada',
                'ion_color_tint' => '#fffcf5',
            ],			
        ]
    ],	

 ...
 * @method Template_Model_Db_Table_Block getTable()
...
class Template_Model_Block extends Core_Model_Default
{
     ...
     * @return mixed
     */
    public static function getWhiteLabelType()
    {
        return self::$_wl_match[__get("editor_design")];
    }
    ...
    /**
     * @param null $white_label_editor_id
     * @return mixed
     */
    public function findByWhiteLabelEditor($white_label_editor_id = null)
    {
        if (!$white_label_editor_id) $white_label_editor_id = 0;
        return $this->getTable()->findByWhiteLabelEditor($white_label_editor_id);
    }
    ...
    public function save()
    {
        ...
        } else if ($this->getWhiteLabelEditorId()) {
            $this->getTable()->saveWhiteLabelEditorBlock($this);
        } else {

...
/**
 * Class Comment_Mobile_ListController
 */
class Comment_Mobile_ListController extends Application_Controller_Mobile_Default
{
    ...
    private function _genericFindAction($value_id, $comments)
    {
        ...
        foreach ($comments as $comment) {
            ...
            $customerImg = $customer->getImage();
            $path = $customer->getImagePath().$customerImg;
                ...
                case 4:
                    ...
                    foreach ($answers as $answer) {
                        $all_answers[] = [
                            ...
                            "message" => \Nwicode\Xss::sanitize($answer->getText()),
                    ...
                    $data["collection"][] = [
                        ...
                        "url" => $this->getPath("comment/mobile_view", [
                                "value_id" => $value_id,
                        ...
                        "embed_payload" => [
                            ...
                            "title" => \Nwicode\Xss::sanitize($comment->getTitle()),
                            "subtitle" => \Nwicode\Xss::sanitize($comment->getSubtitle()),
                            "message" => \Nwicode\Xss::sanitize($comment->getText()),

...
class Comment_Mobile_EditController extends Application_Controller_Mobile_Default {
    ...
    public function createAction() {
        ...
        if ($data = Zend_Json::decode($this->getRequest()->getRawBody())) {
            ...
            try {
                ...
                $comment->setText(\Nwicode\Xss::sanitize($data['text']));
    ...
    /**
     * Create fanwall post Nwicode 5.0
     */
        ...
        try {
            ...
            if($params = Nwicode_Json::decode($request->getRawBody())) {
                ...
                if (!$session->getCustomerId()) {
                    throw new \Nwicode\Exception(__("You must be connected to create a post!"));
                }

                $comment = new Comment_Model_Comment();
                $comment
                    ->setText(\Nwicode\Xss::sanitize($params["text"]))
                ...
                throw new \Nwicode\Exception(__("Missing parameters, value_id or message."));
            }

...
if ($option->getId()) {
    ...
    $data = [
        ...
        "use_my_account" => 1,
        'backoffice_description' => 'This feature is disabled by default since update 4.17.0 and is deprecated in favor of Fanwall v2.'
    ];
    ...
    Nwicode_Feature::installLayouts($option->getId(), $slug, $layout_data);

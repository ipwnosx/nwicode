            ...
            if($value_id = $request->getParam("value_id")) {
                ...
                foreach($menus as $menu) {
                    ...
                    if($menu->getThumbnailUrl()) {
                        ...
                        $thumbnail_b64 = Nwicode_Image::getForMobile($baseUrl, $picture, null, 2048, 2048);
                    }

                    $picture_b64 = null;
                    if($menu->getPictureUrl()) {
                        $picture = Core_Model_Directory::getBasePathTo($menu->getPictureUrl());
                        $picture_b64 = Nwicode_Image::getForMobile($baseUrl, $picture, null, 2048, 2048);
                    }
                ...
                throw new Nwicode_Exception(__("Missing parameter value_id."));
            }

        ...
        try {
            ...
            if (!empty($params['store_id'])) {
                ...
                if ($store->getId() && $mcommerce->getId() !== $store->getMcommerceId()) {
                    throw new Nwicode_Exception(__('The store & mcommerce instances mismatch!'));
                }
            } else {
                $store = new Mcommerce_Model_Store();
            }
            ...
            if (!empty($params['street']) &&
                ...
                list($latitude, $longitude) = Nwicode_Google_Geocoding::getLatLng($address, $this->getApplication()->getGooglemapsKey());
            }

...
class Mcommerce_Model_Cart extends Core_Model_Default {
     ...
     *
     * @return Nwicode_Db_Table_Rowset Collection de lignes du panier
     */
    ...
    protected function _createLine($product) {
        ...
        if($product->getOptions()) {
            foreach($product->getOptions() as $option) {
                ...
                $vat = Nwicode_Currency::getVat($option->getPrice(), $product->getTaxRate());
        ...
        $vat = Nwicode_Currency::getVat($product->getPrice(), $product->getTaxRate());

...
$disable_cron = (!$module->isInstalled() && Nwicode_Version::is("SAE")) ? "1" : "0";
...
$configs = [
    ...
    [
        "code" => "custom_buttonone",
        "label" => "Button 1"
    ],
    [
        "code" => "custom_buttononename",
        "label" => "Button 1 name"
    ],
    [
        "code" => "custom_buttontwo",
        "label" => "Button 2"
    ],
    [
        "code" => "custom_buttontwoname",
        "label" => "Button 2 name"
    ],
    [
        "code" => "custom_buttonthree",
        "label" => "Button 3"
    ],
    [
        "code" => "custom_buttonthreename",
        "label" => "Button 3 name"
    ],
    [
        "code" => "custom_html_code",
        "label" => "Custom HTML"
    ],
    [
        "code" => "logo",
    ...
    [
        "code" => "enable_doforme_button",
        "label" => "Enable do for me button",
        "value" => "0"
    ],
    [
        "code" => "show_supportform_inhome",
        "label" => "Show support form in home page",
        "value" => "0"
    ],
    [

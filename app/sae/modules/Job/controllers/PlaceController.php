    ...
    public function editpostAction() {
        ...
        if($form->isValid($values)) {
            ...
            if($values["banner"] == "_delete_") {
                ...
                $path_banner = Nwicode_Feature::moveUploadedFile($this->getCurrentOptionValue(), Core_Model_Directory::getTmpDirectory()."/".$values['banner'], $values['banner']);
            ...
            if($values["icon"] == "_delete_") {
                ...
                $path_icon = Nwicode_Feature::moveUploadedFile($this->getCurrentOptionValue(), Core_Model_Directory::getTmpDirectory()."/".$values["icon"]);
            ...
            if(!empty($values["location"])) {
                $coordinates = Nwicode_Google_Geocoding::getLatLng(["address" => $values["location"]], $this->getApplication()->getGooglemapsKey());

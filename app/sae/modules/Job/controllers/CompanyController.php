    ...
    public function editpostAction() {
        ...
        if($form->isValid($values)) {
            ...
            if(file_exists(Core_Model_Directory::getBasePathTo("images/application".$values["logo"]))) {
                ...
                $path_logo = Nwicode_Feature::moveUploadedFile($this->getCurrentOptionValue(), Core_Model_Directory::getTmpDirectory()."/".$values['logo']);
            ...
            if(file_exists(Core_Model_Directory::getBasePathTo("images/application".$values["header"]))) {
                ...
                $path_header = Nwicode_Feature::moveUploadedFile($this->getCurrentOptionValue(), Core_Model_Directory::getTmpDirectory()."/".$values['header']);
            ...
            if(!empty($values["location"])) {
                $coordinates = Nwicode_Google_Geocoding::getLatLng(["address" => $values["location"]],

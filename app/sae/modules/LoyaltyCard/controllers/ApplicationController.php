    ...
    public function editpostAction() {
        ...
        if($form->isValid($values)) {
            ...
            if($values["image_active"] == "_delete_") {
                ...
                $path_image_active = Nwicode_Feature::moveUploadedFile($this->getCurrentOptionValue(), Core_Model_Directory::getTmpDirectory()."/".$values['image_active'], $values['image_active']);
            ...
            if($values["image_inactive"] == "_delete_") {
                ...
                $path_image_inactive = Nwicode_Feature::moveUploadedFile($this->getCurrentOptionValue(), Core_Model_Directory::getTmpDirectory()."/".$values['image_inactive'], $values['image_inactive']);

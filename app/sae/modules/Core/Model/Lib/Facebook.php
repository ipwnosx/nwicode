...
class Core_Model_Lib_Facebook extends Core_Model_Default {
    ...
    public static function getAppToken() {
        ...
        $tokenResponse = Nwicode_Request::get('https://graph.facebook.com/v2.7/oauth/access_token', $params);

        if (strpos($tokenResponse, 'access_token=') === false) {
            $result = Nwicode_Json::decode($tokenResponse);
    ...
    public static function getOrRefreshToken($access_token) {
        ...
        $response = Nwicode_Json::decode(file_get_contents($token_url));

...
abstract class Core_Model_Default_Abstract
{
     ...
     *
     * Relative URL will use nwicode main domain root URL as base URL.
     *
     * e.g. :
     * "/app_key/mymodule/mobile_view/findall"
     * will become
     * "https://mynwicode.com/app_key/my/module/mobile_view/findall"
     *
     * @return string[]
     */
     ...
     * "/images/myimage.jpg"
     * will become
     * "https://mynwicode.com/images/myimage.jpg"
     *
     * @return string[]
     */

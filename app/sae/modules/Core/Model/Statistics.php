...
GROUP BY status");
                ...
                $statistics = array(
                    ...
                    "data" => array(
                        "nwicode_version"              => Nwicode_Version::VERSION,
                        "nwicode_type"                 => Nwicode_Version::TYPE,
                        "nwicode_design"               => design_code(),
                        "nwicode_use_https"            => System_Model_Config::getValueFor("use_https"),
                        "nwicode_disable_cron"         => System_Model_Config::getValueFor("disable_cron"),
                        "nwicode_environment"          => System_Model_Config::getValueFor("environment"),
                        "nwicode_update_channel"       => System_Model_Config::getValueFor("update_channel"),
                        "nwicode_cpanel_type"          => System_Model_Config::getValueFor("cpanel_type"),
                        "nwicode_analytic_app_limit"   => System_Model_Config::getValueFor("analytic_app_limit"),
                        "nwicode_signup_mode"          => System_Model_Config::getValueFor("signup_mode"),
                        "nwicode_cron_interval"        => System_Model_Config::getValueFor("cron_interval"),
                        "nwicode_node_binary_path"     => System_Model_Config::getValueFor("node_binary_path"),
                        "nwicode_installation_date"    => System_Model_Config::getValueFor("installation_date"),
                        "nwicode_licence_key"          => System_Model_Config::getValueFor("nwicodecms_key"),
                        "nwicode_disk_usage"           => System_Model_Config::getValueFor("disk_usage_cache"),
                        "nwicode_letsencrypt_disabled" => System_Model_Config::getValueFor("letsencrypt_disabled"),
                        "nwicode_ios_autobuild_key"    => System_Model_Config::getValueFor("ios_autobuild_key"),
                        "nwicode_modules"              => $modules,
                        "nwicode_features"             => $features_usage,
                        "nwicode_layouts"              => $layouts_usage,
                ...
                $request = new Nwicode_Request();
                $request->post(sprintf("http://nwicode.com/campaign.php?type=%s", Nwicode_Version::TYPE), $statistics);

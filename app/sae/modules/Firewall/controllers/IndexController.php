...
class Firewall_IndexController extends Backoffice_Controller_Default
{
    ...
    public function deletefwuploadruleAction()
    {
        try {
            ...
            if (empty($params)) {
                throw new \Nwicode\Exception(__('Missing value'));
            }
    ...
    public function addfwuploadruleAction()
    {
        try {
            ...
            if (empty($value)) {
                throw new \Nwicode\Exception(__("Extension can't be empty."));
            }

            if (in_array($value, ['php', 'js', 'ico'])) {
                throw new \Nwicode\Exception(__("Extension %s is strictly forbidden.", $value));
            }
    ...
    public function savefwclamdsettingsAction()
    {
        try {
            ...
            if (empty($params)) {
                throw new \Nwicode\Exception(__('Missing values'));
            }

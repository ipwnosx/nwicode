...
class Application_Model_Device_Ionic_Android extends Application_Model_Device_Ionic_Android_Abstract
{
            ...
            if (defined('IS_APK_SERVICE')) {
                ...
                Nwicode_Request::get(
                    ...
                    [
                        ...
                        'license' => base64_encode(__get('nwicodecms_key')),
                ...
                if (!in_array(Nwicode_Request::$statusCode, [100, 200, 201])) {
                    throw new \Nwicode\Exception(__('Cannot send APK build to service %s.',
                        Nwicode_Request::$statusCode));
                }
            } else {
                $this->_prepareApk();
    ...
    {
        if (!defined('CRON')) {
            $request = new Nwicode_Controller_Request_Http($this->app->getUrl());
            $request->setPathInfo();

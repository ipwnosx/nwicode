        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                if (!empty($data["googlemaps_key"])) {
                    Nwicode_Google_Geocoding::testApiKey($data["googlemaps_key"]);
                ...
                if (!empty($data["appmetrica_key"])) {
                    $application->setAppmetricaKey($data["appmetrica_key"]);
                } else {
                    $application->setAppmetricaKey("");
                }

                if (!empty($data["appmetrica_app_id"])) {
                    $application->setAppmetricaAppId($data["appmetrica_app_id"]);
                } else {
                    $application->setAppmetricaAppId("");
                }

                if (!empty($data["oauth_yandex_token"])) {
                    $application->setOauthYandexToken($data["oauth_yandex_token"]);
                } else {
                    $application->setOauthYandexToken("");
                }

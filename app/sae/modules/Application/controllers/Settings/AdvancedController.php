    ...
    public function saveformAction()
    {
        ...
        if ($form->isValid($request->getParams())) {
            ...
            $application
                ...
                ->setSmtpCredentials(Nwicode_Json::encode($request->getParam("smtp_credentials")))
                ->save();
    ...
    public function saveorientationsAction()
    {
        try {
            ...
            if (!$defaults['android-portrait'] &&
                ...
                throw new \Nwicode\Exception(__('You must select at least one orientation for Android!'));
            }
            ...
            if (!in_array($defaults['android'], $androidValids)) {
                throw new \Nwicode\Exception(__('Android orientation is invalid!'));
            }
            ...
            if (!$defaults['iphone-portrait'] &&
                ...
                throw new \Nwicode\Exception(__('You must select at least one orientation for iPhone!'));
            }
            ...
            if (!$defaults['ipad-portrait'] &&
                ...
                throw new \Nwicode\Exception(__('You must select at least one orientation for iPad!'));
            }

            $iosDevice
                ->setOrientations(Nwicode_Json::encode($defaults))
                ->save();

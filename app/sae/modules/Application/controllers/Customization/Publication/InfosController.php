...
class Application_Customization_Publication_InfosController extends Application_Controller_Default
{
    ...
    public function saveGeneralInformationAction()
    {
        try {
            ...
            if (!$application->getId()) {
                throw new \Nwicode\Exception(__('This application does not exists.'));
            }
    ...
    public function downloadsourceAction()
    {
        ...
        if (__getConfig('is_demo')) {
            // Demo version
            throw new \Nwicode\Exception("This is a demo version, the source code can't be downloaded");
        } else {
            if ($data = $this->getRequest()->getParams()) {
                ...
                if (!$application->subscriptionIsActive()) {
                    throw new \Nwicode\Exception("You have to purchase the application before downloading the mobile source code.");
                }
                ...
                if ($type == "apk" && !$this->getAdmin()->canGenerateApk()) {
                    throw new \Nwicode\Exception("You are not allowed to generate APK.");
                }

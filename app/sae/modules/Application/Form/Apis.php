 ...
 */
class Application_Form_Apis extends Nwicode_Form_Abstract
{
    /**
     * @var string
     */
    ...
    public function localInit()
    {
        ...
        $this->groupElements(
            ...
            $this->addSimpleText("appmetrica_key", __("AppMetrica yandex API Key"));
            $this->addSimpleText("appmetrica_app_id", __("AppMetrica yandex app id"));
            $this->addSimpleText("oauth_yandex_token", __("OAuth app yandex token"));
            $this->groupElements(
                "app_metrica",
                [
                    "appmetrica_key",

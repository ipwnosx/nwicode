...
$link_option = Nwicode_Feature::install($category, $data, array('code'));
...
$links_option = Nwicode_Feature::install($category, $data, array('code'));
...
foreach($features as $feature_name => $feature) {
    ...
    $result = Nwicode_Feature::installIcons($feature_name, $icons);
    ...
    # Icons Flat
    Nwicode_Feature::removeIcons("{$feature_name}-flat");
    Nwicode_Feature::installIcons("{$feature_name}-flat", $feature['icons_flat']);
}

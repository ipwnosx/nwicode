    ...
    public function getEmbedPayload($optionValue)
    {
        ...
        if ($this->getId()) {
            ...
            if ($this->getCoverUrl()) {
                ...
                $payload["weblink"]["cover_url"] = Nwicode_Image::open($picture_file)->inline("png");
            }

            try {
                $settings = \Nwicode_Json::decode($optionValue->getSettings());
            ...
            foreach ($this->getLinks() as $link) {
                ...
                if ($link->getPictoUrl()) {
                    ...
                    $picto_b64 = Nwicode_Image::open($picture_file)->inline("png");
                }

 ...
 */
angular.module('starter').service('layout_nwicode_swipe', function ($rootScope, $timeout, $session) {
    var service = {};
    ...
    service.getTemplate = function () {
        return 'modules/layout/home/layout_nwicode_swipe/view.html';
    };
        ...
        $session
            ...
            .then(function (lastIndex) {
                $timeout(function () {
                    ...
                    swipe_instance = new Swiper('.layout.layout_nwicode_swipe .swiper-container', {
                        direction: 'vertical',
                        loop: (options.loop === '1'),
                        effect: 'coverflow',
                        centeredSlides: true,

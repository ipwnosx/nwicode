 ...
 */
class Contact_Form_Contact extends Nwicode_Form_Abstract
{
    ...
    public function init()
    {
        ...
        $this->addSimpleText("whatsapp", p__("contact","Whatsapp"));
        $this->addSimpleText("email", p__("contact","E-mail"));
        $this->addSimpleText("website", p__("contact","Website"));
        $this->addSimpleText("vkontakte", p__("contact","Vkontakte"));

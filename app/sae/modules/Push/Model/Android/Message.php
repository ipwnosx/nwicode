...
class Push_Model_Android_Message
{
    ...
    /**
     * @var \Nwicode\CloudMessaging\Sender\Gcm
     */
    private $service_gcm = null;

    /**
     * @var \Nwicode\CloudMessaging\Sender\Fcm
     */
    ...
    /**
     * @var null|Nwicode_Log
     */
    private $logger = null;

    /**
     * Push_Model_Android_Message constructor.
     * @param \Nwicode\CloudMessaging\Sender\Fcm $serviceFcm
     * @param \Nwicode\CloudMessaging\Sender\Gcm $serviceGcm
    ...
    private function _pushToProvider ($provider, $message, $tokens, $deviceByToken)
    {
        ...
        } catch (\Nwicode\CloudMessaging\InvalidRequestException $e) { # server returned HTTP code other than 200 or 503
        ...
        if (!empty($error)) {
            throw new Nwicode_Exception($error);
        }
    }

    /**
     * @return \Nwicode\Service\Push\CloudMessaging\Message
     */
    public function buildMessage()
    {
        $messagePayload = new \Nwicode\Service\Push\CloudMessaging\Message();

...
$binary_path = Core_Model_Directory::getBasePathTo("lib/Nwicode/Wrapper/Sqlite/bin");
...
$dbPath = Core_Model_Directory::getBasePathTo("metrics/nwicodecms.db");
...
$wrapperDB = Nwicode_Wrapper_Sqlite::getInstance()
            ->setSchema($dbSchema)
            ->setDbPath($dbPath);

...
class Wordpress2_ApplicationController extends Application_Controller_Default
{
    ...
    public function loadqueryformAction() {
        ...
        if ($wordpressQuery->getId()) {
            ...
            $selectedCategories = Nwicode_Json::decode($wordpressQuery->getQuery())['categories'];
            $selectedPages = Nwicode_Json::decode($wordpressQuery->getQuery())['pages'];

...
class Media_Mobile_Api_Music_PlaylistController extends Application_Controller_Mobile_Default {
    ...
    /** API v2 introduced in Nwicode 5.0 with Progressive Web Apps. */
    ...
    public function findallv2Action() {
        ...
        try {
            ...
            if($value_id = $request->getParam("value_id")) {
                ...
                $artwork_placeholder_b64 = Nwicode_Image::open($artwork_placeholder)->inline();
                $album_cover_b64 = Nwicode_Image::open($artwork_placeholder)->cropResize(64)->inline();

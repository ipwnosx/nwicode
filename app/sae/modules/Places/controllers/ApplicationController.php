...
class Places_ApplicationController extends Application_Controller_Default
{
    ...
    public function updatePinsAction()
    {
        ...
        try {
            ...
            if (!$pinValue) {
                throw new \Nwicode\Exception(__("The pin value is required"));
            }
    ...
    public function updateCategoryPositionsAction()
    {
        try {
            ...
            if (empty($indexes)) {
                throw new \Nwicode\Exception(__('Nothing to do!'));
            }
            ...
            foreach ($indexes as $index => $categoryId) {
                ...
                if (!$category->getId()) {
                    throw new \Nwicode\Exception(__('Something went wrong, the category do not exists!'));
                }
    ...
    public function editCategoryAction()
    {
        ...
        try {
            if ($form->isValid($params)) {
                ...
                Nwicode_Feature::formImageForOption(
                    $optionValue,
                    $category,
                    $params,
                    'picture',
    ...
    public function editSettingsAction()
    {
        ...
        try {
            if ($form->isValid($params)) {
                ...
                $optionValue
                    ->setSettings(\Nwicode_Json::encode($filteredValues))
                    ->save();
    ...
    public function loadCategoryFormAction()
    {
        try {
            ...
            if (!$category->getId()) {
                throw new \Nwicode\Exception(__("The category you are trying to edit doesn't exists.."));
            }
    ...
    public function loadformAction()
    {
        try {
            ...
            try {
                $settings = \Nwicode_Json::decode($settings);
            } catch (\Exception $e) {
                $settings = [
                    "defaultPin" => "image"
                ];

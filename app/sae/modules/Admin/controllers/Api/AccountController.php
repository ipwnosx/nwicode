...
class Admin_Api_AccountController extends Api_Controller_Default
{
    ...
    public function existAction()
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                if (empty($data["email"])) {
                    throw new \Nwicode\Exception(__("The email is required"));
                }
    ...
    public function authenticateAction()
    {
        ...
        try {
            ...
            if (empty($data["password"])) {
                throw new \Nwicode\Exception(__("The password is required"));
            }
            ...
            if (!$admin->getId()) {
                throw new \Nwicode\Exception("The user doesn't exist.");
            }

            if (!$admin->authenticate($password)) {
                throw new \Nwicode\Exception(__("Authentication failed."));
            }
    ...
    public function createAction()
    {
        try {
            ...
            if (!$data) {
                throw new \Nwicode\Exception('dqzdqzdzq');
            }
            ...
            if (!empty($data['user_id'])) {
                throw new \Nwicode\Exception(__("Unable to update a user from here."));
            }
            if (empty($data['email'])) {
                throw new \Nwicode\Exception(__("The email is required"));
            }
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                if (!empty($data["user_id"])) {
                    ...
                    if (!$admin->getId()) {
                        throw new \Nwicode\Exception(__("This admin does not exist"));
                    }
                ...
                if (__getConfig('is_demo')) {
                    if (in_array($data['email'], ['demo@demo.com', 'client@client.com'])) {
                        throw new \Nwicode\Exception(__("This action is not allowed in demo."));
                    }
                }
    ...
    public function forgotpasswordAction()
    {
        ...
        try {
            if ($data = $this->getRequest()->getPost()) {
                if (empty($data['email'])) {
                    throw new \Nwicode\Exception(__('Please enter your email address'));
                }
                ...
                if (!$admin->getId()) {
                    throw new \Nwicode\Exception(__("This email address does not exist"));
                }

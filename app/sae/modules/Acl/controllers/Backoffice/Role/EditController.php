        ...
        try {
            ...
            if ($defaultRoleId == $role->getId() &&
                ...
                if (__getConfig('is_demo')) {
                    // Demo version
                    throw new \Nwicode\Exception(__('This is a demo version, you are not allowed to change the default role.'));
                }
    ...
    private function checkHierarchy($parentId, $roleId)
    {
        while ($parentId != null) {
            ...
            if ($role->getId() &&
                ...
                throw new \Nwicode\Exception(__("You can't assign a role to this child role, this will break the hierarchy!"));
            }
        }
    }

...
class Backoffice_Model_Notification extends Core_Model_Default {
    ...
    public function update() {
        ...
        $type = (Nwicode_Version::is("PE")) ? "platform" : "multiapps";

        $last_id = $this->findLastId();
        $url = 'https://nwicode.com/notification.php?type='.$type.'&last_id='.$last_id; 
        try {
    ...
    public static function getMessages() {
        try {
            ...
            foreach ($messages as $message) {
                ...
                if(strpos($link, "updates.nwicodecms.com") !== false) {

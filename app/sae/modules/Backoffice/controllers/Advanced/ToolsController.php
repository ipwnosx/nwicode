...
class Backoffice_Advanced_ToolsController extends System_Controller_Backoffice_Default
{
    ...
    {
        $data = Nwicode_Tools_Integrity::checkIntegrity();
    ...
    public function restoreappsAction()
    {
        try {
            ...
            $releaseUrl = 'https://updates.nwicode.com/public/v' . $version;
            Nwicode_Request::get($releaseUrl);
            if (Nwicode_Request::$statusCode == '404') {
                throw new Exception(__('There is not corresponding release to restore from, process aborted!'));
            }

            $browser = 'https://updates.nwicode.com/public/app/v' . $version . '/nwicode/var/apps/browser.tgz';
            $android = 'https://updates.nwicode.com/public/app/v' . $version . '/nwicode/var/apps/ionic/android.tgz';
            $ios = 'https://updates.nwicode.com/public/app/v' . $version . '/nwicode/var/apps/ionic/ios.tgz';
    ...
    public function migratetoredisAction()
    {
        try {
            if (!class_exists('Redis')) {
                throw new Nwicode_Exception(__('php-redis module is required!'));
            }

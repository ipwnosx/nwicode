    ...
    public function findAction()
    {
        ...
        try {
            ...
            if ($value_id = $this->getRequest()->getParam('value_id')) {
                ...
                throw new \Nwicode\Exception("The value_id is required.");
            }
        ...
        try {
            ...
            if ($data = Nwicode_Json::decode($this->getRequest()->getRawBody())) {
                ...
                if (!empty($errors)) {
                    ...
                    if (!$store->getId()) {
                        throw new Nwicode_Exception(__("An error occurred during process.<br />Please try again later."));
                    }
                    ...
                    if (!$booking->getId()) {
                        throw new \Nwicode\Exception(__("An error occurred during process.<br />Please try again later."));
                    }
                ...
                throw new \Nwicode\Exception("The sent request is empty.");
            }

...
class Translation_Backoffice_EditController extends Backoffice_Controller_Default
{
    ...
    public function saveAction()
    {
        try {
            ...
            if (__getConfig("is_demo")) {
                // Demo version
                throw new \Nwicode\Exception(__("You cannot change translation, this is a demo version."));
            }

            if (empty($data)) {
                throw new \Nwicode\Exception(__("Missing data, unable to save!"));
            }
            ...
            if (empty($countryCode)) {
                throw new \Nwicode\Exception(__("Please, choose a language."));
            }
            if (empty($translationFile)) {
                throw new \Nwicode\Exception(__("Please, choose a file."));
            }
    ...
    public function translateAction()
    {
        ...
        $data = Nwicode_Json::decode($this->getRequest()->getRawBody());
        ...
        if ($translation->getId()) {
            ...
            if (empty($yandex_key)) {
                ...
                $response = Nwicode_Json::decode(file_get_contents($url));
    ...
    public function suggestAction ()
    {
        try {
            ...
            // Public API
            Nwicode_Request::post(
                "https://translate.nwicodecms.com/api/translations/nwicode/{$component}/{$language}/file/",
                [
                    "method" => "suggest",

 ...
 */
class Promotion_Form_Promotion extends Nwicode_Form_Abstract {
    ...
    public function init() {
        ...
        $end_at = $this->addSimpleDatetimepicker(
            ...
            __("End at"),
            false,
            Nwicode_Form_Abstract::DATEPICKER,
            'yy-mm-dd'
        );

        $end_at->addValidator(new Nwicode_Form_Validate_DateGreaterThanToday(), true);
